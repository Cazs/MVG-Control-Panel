...
export const db_trips = new NeDatastore({ filename: path.join(__dirname,  '../db/trips.db'), autoload: true });
export const db_enquiries = new NeDatastore({ filename: path.join(__dirname,  '../db/enquries.db'), autoload: true });
