...
// ENQUIRY
// ===========================================================
export const ENQUIRY_EDIT = 'ENQUIRY_EDIT';
export const ENQUIRY_UPDATE = 'ENQUIRY_UPDATE';
export const ENQUIRY_SAVE = 'ENQUIRY_SAVE';
export const ENQUIRY_DELETE = 'ENQUIRY_DELETE';
export const ENQUIRY_GET_ALL = 'ENQUIRY_GET_ALL';
export const ENQUIRY_SET_STATUS = 'ENQUIRY_SET_STATUS';
export const ENQUIRY_CONFIGS_SAVE = 'ENQUIRY_CONFIGS_SAVE';
export const ENQUIRY_DUPLICATE = 'INVOICE_DUPLICATE';
