...
export const USER_CONFIGS_SAVE = 'USER_CONFIGS_SAVE';
...
// TRIP
// ===========================================================
export const TRIP_NEW = 'TRIP_NEW';
export const TRIP_EDIT = 'TRIP_EDIT';
export const TRIP_UPDATE = 'TRIP_UPDATE';
export const TRIP_TASK_ADD = 'TRIP_TASK_ADD';
export const TRIP_SAVE = 'TRIP_SAVE';
export const TRIP_DELETE = 'TRIP_DELETE';
export const TRIP_GET_ALL = 'TRIP_GET_ALL';
export const TRIP_SET_STATUS = 'TRIP_SET_STATUS';
export const TRIP_CONFIGS_SAVE = 'TRIP_CONFIGS_SAVE';
export const TRIP_DUPLICATE = 'TRIP_DUPLICATE';
...
// ===========================================================
export const ACCOMMODATION_BOOKING_EDIT = 'ACCOMMODATION_BOOKING_EDIT';
export const ACCOMMODATION_BOOKING_UPDATE = 'ACCOMMODATION_BOOKING_UPDATE';
export const ACCOMMODATION_BOOKING_SAVE = 'ACCOMMODATION_BOOKING_SAVE';
export const ACCOMMODATION_BOOKING_DELETE = 'ACCOMMODATION_BOOKING_DELETE';
export const ACCOMMODATION_BOOKING_GET_ALL = 'ACCOMMODATION_BOOKING_GET_ALL';
export const ACCOMMODATION_BOOKING_SET_STATUS = 'ACCOMMODATION_BOOKING_SET_STATUS';
export const ACCOMMODATION_BOOKING_CONFIGS_SAVE = 'ACCOMMODATION_BOOKING_CONFIGS_SAVE';
export const ACCOMMODATION_BOOKING_DUPLICATE = 'INVOICE_DUPLICATE';

// TRIP_BOOKING
// ===========================================================
export const TRIP_BOOKING_EDIT = 'TRIP_BOOKING_EDIT';
export const TRIP_BOOKING_UPDATE = 'TRIP_BOOKING_UPDATE';
export const TRIP_BOOKING_SAVE = 'TRIP_BOOKING_SAVE';
export const TRIP_BOOKING_DELETE = 'TRIP_BOOKING_DELETE';
export const TRIP_BOOKING_GET_ALL = 'TRIP_BOOKING_GET_ALL';
export const TRIP_BOOKING_SET_STATUS = 'TRIP_BOOKING_SET_STATUS';
export const TRIP_BOOKING_CONFIGS_SAVE = 'TRIP_BOOKING_CONFIGS_SAVE';
export const TRIP_BOOKING_DUPLICATE = 'INVOICE_DUPLICATE';
...
export const MESSAGE_CONFIGS_SAVE = 'MESSAGE_CONFIGS_SAVE';
export const MESSAGE_DUPLICATE = 'INVOICE_DUPLICATE';